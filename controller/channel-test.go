...
func testChannel(channel *model.Channel, testModel string) (err error, openAIErrorWithStatusCode *dto.OpenAIErrorWithStatusCode) {
	...
	other := service.GenerateTextOtherInfo(c, info, priceData.ModelRatio, priceData.GroupRatio, priceData.CompletionRatio, usage.PromptTokensDetails.CacheCreationTokens, usage.PromptTokensDetails.CachedTokens, priceData.CacheRatio, priceData.ModelPrice)
