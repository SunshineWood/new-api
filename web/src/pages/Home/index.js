            ...
            <>
              ...
              <div className="vertical-scroll-container">
                <div className="vertical-scroll-content">
                  <p>⚠️
                    本网站完全同步官方计费，只有一个分组1:1计费，全部为官方中转，人头保证，充值为6.5元充值1美金，加群联系群主获取优惠充值方案！</p>
                  <p>🆕
                    Claude全模型已兼容v1/messages官方请求格式，并且完全通过官方缓冲创建和缓冲命中计费规则！</p>
                  <p>⚠️
              ...
              <div className="content-section">
                  ...
                  <div className="section-content">
                    ...
                    <div className="intro-text">
                      <p>🌍 <span
                        ...
                        calling，N参数，response_format等结构化输出验证），已触达国内各种闲杂人员等<span
                            className="highlight">已稳定运行25个月</span>
                      </p>

                      <p>💰 为方便计费，一个账号通用本站所有模型，本站当前兑换比例为6.5:1<span
                      ...
                      <p>🎈 <span className="highlight">100%</span>同步官方计费倍率和规则，<span
                          className="highlight">无掺假无广告无保留或出售数据，性价比最高的稳定三无纯净API源头！</span>
                      </p>
                      ...
                      <p>🇺🇸 我们多机部署了<span
                          className="highlight"><a>10台</a></span>离OpenAI最近的<span
                ...
                <section id="实时接口状态">
                  ...
                  <div className="section-content">
                    ...
                    <h2>支持模型（实时更新全网最新模型，一手渠道，当前模型总数为</h2>
                    <p>
                      <img
                          src="https://uptime.mossx.tech/api/badge/1/uptime?labelPrefix=Anthropic%E6%8E%A5%E5%8F%A3%E7%8A%B6%E6%80%81+&suffix=%25%E5%8F%AF%E7%94%A8&style=for-the-badge"
                          alt="Anthropic"/>
                      <img
                          src="https://uptime.mossx.tech/api/badge/1/uptime?labelPrefix=OpenAI%E6%8E%A5%E5%8F%A3%E7%8A%B6%E6%80%81+&suffix=%25%E5%8F%AF%E7%94%A8&style=for-the-badge"
                          alt="openai"/>
                    </p>
                  </div>
                </section>
                ...
                <section id="快速开始">
                  ...
                  <div className="section-content">
                    ...
                    <p><span className="highlight">1秒使用：点击<a
                        href="https://api.mossx.tech/token">令牌</a>，创建一个令牌，点击令牌后面的【聊天】即可一键导入使用</span>
                    </p>
                    <p><span className="highlight">本程序经过二次开发（可代部署），支持使用我们网站的所有模型，选择模型后会有上传按钮，支持上传所有类型文件进行分析、官方多模态分析、语音转文本（whisper-1），文本转语音（tts1）、GPTS、🎨 Midjourney绘图，如果无法找到需要的模型请在自定义模型输入模型名称并选择即可</span>
                    </p>
                    <p>温馨提示：本聊天程序已默认填写了本站的接口地址，您直接填入本站后台生成的令牌
                      key即可使用，如您需要使用官方账号生成的令牌 key
                      请在设置中将接口地址修改为【api.openai.com】即可，有任何问题请点击设置最下面的【立即清除】</p>
